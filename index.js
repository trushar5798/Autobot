...
var Bing = require('node-bing-api')({ accKey: "0865b6bbe0734fdbb829698e605ca91a" });
...
restService.post("/echo", function(req, res) {
  if (
    ...
    Bing.web(search, {
        ...
        ser = body.webPages.value[0].url;//"<div class='card-title'><a href='"+body.webPages.value[0].url+"' target='_blank'>"+body.webPages.value[0].name+"</a></div>";
        return res.json({
          fulfillmentMessages: [
            {
              text: {
